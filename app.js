...
document.querySelector('#logo img').addEventListener('mouseover', (e)=>
{
    e.target.setAttribute('src', 'http://www.youloveit.ru/uploads/posts/2017-05/1494861649_youloveit_ru_kot_pushin02.png');
})
